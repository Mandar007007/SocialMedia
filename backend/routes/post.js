...
const { createPost, likeAndUnlikePost, deletePost, getPostOfFollowing, updateCaption, commentOnPost, deleteComment, getMyPosts, getLikedPosts, getRecommendation, getLikedOfProuser, getPostById } = require("../controllers/post");
