...
const { createPost, likeAndUnlikePost, deletePost, getPostOfFollowing, updateCaption, commentOnPost, deleteComment, getMyPosts, getLikedPosts, getRecommendation } = require("../controllers/post");
