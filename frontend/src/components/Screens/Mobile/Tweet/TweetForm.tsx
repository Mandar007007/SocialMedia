    ...
    <>
      ...
      >
        ...
        <motion.input
          ...
          className="my-2 py-3 bg-transparent border-gray-400 focus:outline-none focus:border-slate-500 focus:invalid:border-pink-600 invalid:border-pink-600 appearance-none"
          placeholder="What's in your mind!"
          onChange={handleChange}
        />
